        ...
        <div class='flex flex-col gap-4'>
            ...
            <div class='flex flex-col gap-4'>
                {schedule().hasSchool && schedule().periods ? (
                    schedule().periods!.map(p => (
                        <div class='flex gap-4 px-4 py-2'>
                            <div
                                class={
                                    ...
                                    (!lookAhead() && p.end <= defaultDate().secondMidnight
                                        ? 'bg-theme-300 dark:bg-themedark-800'
                                        : 'bg-theme-400 dark:bg-themedark-700')
                                }
                            />
                            <div
                                class={
                            ...
                            >
                                ...
                                <div
                                    class={
                                        'text-md flex items-center gap-2 text-milk-800 transition-colors dark:text-rice-200 ' +
                                        (!lookAhead() && p.end <= defaultDate().secondMidnight
                    ...
                    <p class='text-md flex items-center justify-center text-lg font-bold text-milk-800 dark:text-rice-200'>
