...
export const BottomBar: Component = () => {
    ...
    return (
        <div class='bg-milk-200 dark:bg-rice-800 fixed bottom-0 z-10 flex w-full flex-row justify-evenly gap-6 pt-2 shadow-lg transition-colors pb-safe-or-2 px-safe-or-4'>
            {pageOptions
